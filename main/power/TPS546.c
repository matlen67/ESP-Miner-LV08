...
static uint16_t TPS546_I2C_ADDR[3] = {0x24, 0x7F, 0x14}; //U2, U1, U3
...
void TPS546_write_entire_config(int8_t i2c_addr)
{
    ...
    if(tps546_config.TPS546_INIT_COMPENSATION_CONFIG[0] != 0 &&
       ...
       tps546_config.TPS546_INIT_COMPENSATION_CONFIG[4] != 0 ) {
        ...
        smb_write_block(PMBUS_COMPENSATION_CONFIG, tps546_config.TPS546_INIT_COMPENSATION_CONFIG, 5, i2c_addr);
